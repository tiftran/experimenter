...
def generate_change_log(old_serialized_vals, new_serialized_vals, instance, changed_data, user, message=None, form_fields=None):
    changed_values = {}
    old_status = None
    ...
    if latest_change:
        ...
        if (
            old_serialized_vals["variants"] !=
            new_serialized_vals["variants"]
        ):
